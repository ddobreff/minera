...
MINER_OPT="--gc3355-detect --gc3355-autotune --freq=850 -o stratum+tcp://us-east.multipool.us:7777 -u michelem.minera -p x --retries=1"
...
echo -n "claymoredualminer" | redis-cli -x set gpu_network_miners_software
